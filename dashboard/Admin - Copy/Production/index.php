      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>F Dashboard</span></a>
          </div>
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="index3.html">Employee</a></li>
                  </ul>
                </li>
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open" style="padding-left: 15px;">
                ...
                <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                  ...
                  <button class="dropdown-item"><i class="fa fa-sign-out pull-right"> Log Out</i></button>
                </div>
              </li>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  $name = $_POST['your_name']; // Access the 'name' input field value
  $password = $_POST['your_pass']; // Access the 'email' input field value

  // Process the form data as needed
  // For example, you can echo the submitted data
  echo "Name: $name<br>";
  // echo "Email: $email";
}
?>