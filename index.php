  ...
  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block navbar-klean"
      ...
      <div class="container"><a class="navbar-brand" href="index.html"> <img class="me-3 d-inline-block"
            src="assets/img/gallery/logo.png" alt="" /></a>
        <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse"
          data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false"
          aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto pt-2 pt-lg-0 font-base">
            <li class="nav-item px-2" data-anchor="data-anchor"><a class="nav-link fw-medium active rounded-pill"
                aria-current="page" href="#home">Home</a></li>
            <li class="nav-item px-2" data-anchor="data-anchor"><a class="nav-link" href="#service">Service</a></li>

            <li class="nav-item px-2" data-anchor="data-anchor"><a class="nav-link" href="#testimonial">Testimonial</a>
            </li>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-7 col-lg-6 py-6 text-sm-start text-center">
            ...
            <p class="mb-5 fs-0">We xyz offer a platform to bridge the gap between quality individuals <br
                class="d-none d-lg-block" /> and employers building a chain of successful partnerships.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="pb-lg-0 pt-md-8 py-0">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-xl-between py-5 border-klean">
          <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="assets/img/gallery/google.png"
              height="40" alt="brands" /></div>
          <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="assets/img/gallery/netflix.png"
              height="40" alt="brands" /></div>
          <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="assets/img/gallery/microsoft.png"
              height="40" alt="brands" /></div>
          <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="assets/img/gallery/theme-wagon.png"
              height="40" alt="brands" /></div>
          <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="assets/img/gallery/mailbluster.png"
              height="40" alt="brands" /></div>
        </div>
      </div>
      <!-- end of .container-->
      ...
      <div class="container-xl">
        <div class="row flex-center circle-blend circle-blend-left-product circle-cyan">
          ...
          <div class="col-lg-6 ms-lg-auto my-7 my-lg-0 px-sm-8 px-lg-0 ps-lg-2 ps-xl-0">
            ...
            <p class="fs-1 mb-3 pe-xxl-8">XYZ is not only a bridge between you and recruiters but it is a way between
              you and your success.</p>
            <p class="fs-1 mb-5 pe-xxl-8"> XYZ is an elegant website and a perfect starting point for your carrier,
        ...
        <div class="row flex-center pt-10 pt-md-6 pt-lg-10 circle-blend circle-blend-right-dedicated circle-danger">
          ...
          <div class="col-lg-6 order-1 order-lg-0 ms-xl-auto my-7 my-xl-0 px-sm-8 px-lg-3 px-xl-0 me-xl-auto ps-xl-0">
            ...
            <p class="fs-1 mb-3 pe-xxl-8">you might be thinking "Why Only You?" The reason is we recriut you as
              per your skills and intrest.</p>
            <p class="fs-1 mb-5 pe-xxl-8">We see where "your" intrest lies and suggest based on it and that's the
      ...
      <div class="container">
        ...
        <div class="row justify-content-center mb-6">
          <div class="col-lg-6 text-center mx-auto mb-7">
            ...
            <p class="mb-0">People from various origins, cultures, and personalities make up our team. This blend makes
              it a powerful team</p>
          </div>
          <div class="col-xxl-9">
            <div class="row flex-center g-0">
              <div class="col-sm-6 col-lg-3 text-center">
                <div class="wrapper shadow-square-right"><img class="team-card-1" src="assets/img/gallery/john.png"
                    width="200" alt="..." /></div>
                <h5 class="text-800 fw-bold mt-4 mb-1">Jani Bhargesh</h5>
                <p>Team leader</p>
              </div>
              <div class="col-sm-6 col-lg-3 text-center">
                <div class="wrapper shadow-square-left"><img class="team-card-2" src="assets/img/gallery/carrey.png"
                    width="200" alt="..." /></div>
                <h5 class="text-800 fw-bold mt-4 mb-1">Aryan Tankariya</h5>
                <p>Front-end Developer</p>
              </div>
              <div class="col-sm-6 col-lg-3 text-center">
                <div class="wrapper shadow-square-right"><img class="team-card-3" src="assets/img/gallery/ray.png"
                    width="200" alt="..." /></div>
                <h5 class="text-800 fw-bold mt-4 mb-1">Rukaiya Rampurawala</h5>
                <p>Developer</p>
              </div>
              <div class="col-sm-6 col-lg-3 text-center">
                <div class="wrapper shadow-square-left"><img class="team-card-4" src="assets/img/gallery/3.jpg"
                    width="200" alt="..." /></div>
              ...
              <div class="col-sm-6 col-lg-3 text-center">
                <div class="wrapper shadow-square-left"><img class="team-card-4" src="assets/img/gallery/8.jpg"
                    width="200" alt="..." /></div>
              ...
              <div class="carousel-inner ps-sm-7 pb-sm-7 ps-md-5 ps-lg-7 pb-lg-7">
                <div class="carousel-item active" data-bs-interval="10000">
                  <div class="row h-100 align-items-center">
                      ...
                      <div class="wrapper shadow-square-left-bottom">
                        <div class="card testimonial-card-bg h-100">
                          <div class="card-body h-100 p-4"><img class="border-klean-gradient"
                              src="assets/img/gallery/testimonial.png" alt="testimonials" width="315" /></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-5 col-lg-6 col-xl-7 mb-4 ms-xxl-auto"><img class="img-fluid"
                      ...
                      <h5 class="fw-bold text-gradient fs-4 mt-4">Outstanding!!</h5>
                      <p class="mt-4 pe-xxl-8">I just wanted to drop you a little email to say thank you for all your
                        hard work. I'm delighted I chose you as my partner. Your recruiters are really outstanding it
                        feels blessed
                        to work here, It's fantastic.</p>
                      <div class="my-4">
                        <svg class="bi bi-star-fill me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                          fill="#EFAB18" viewBox="0 0 16 16">
                          <path
                      ...
                      <h6 class="fw-bold fs-lg-1">Pratham Gajra<span class="ms-2 fw-normal text-400 fs--1">Web
                          Developer</span></h6>
                    </div>
                  </div>
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                  <div class="row h-100 align-items-center">
                    ...
                    <div class="col-md-5 col-lg-6 col-xl-7 mb-4 ms-xxl-auto"><img class="img-fluid"
                        src="assets/img/gallery/quotation.png" alt="testimonials-bg" />
                      <h5 class="fw-bold text-gradient fs-4 mt-4">Amazing!!</h5>
                      <p class="mt-4 pe-xxl-8">I'm really very thankfull to you for your support. You surved me one
                      ...
                      <h6 class="fw-bold fs-lg-1">Anjali Verma,<span class="ms-2 fw-normal text-400 fs--1">Mobile App
                          Developer</span></h6>
                    </div>
                  </div>
                </div>
                <div class="carousel-item" data-bs-interval="3000">
                  <div class="row h-100 align-items-center">
                    ...
                    <div class="col-md-5 col-lg-6 col-xl-7 mb-4 ms-xxl-auto"><img class="img-fluid"
                        src="assets/img/gallery/quotation.png" alt="testimonials-bg" />
                      <h5 class="fw-bold text-gradient fs-4 mt-4">Life Altering!!</h5>
                      <p class="mt-4 pe-xxl-8">I'm so thankful to you for giving me this opportunity.
                        Just because of you now I'm working in one the best companies of India</p>
                      <div class="my-4">
                        <svg class="bi bi-star-fill me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                          fill="#EFAB18" viewBox="0 0 16 16">
                          <path
                      ...
                      <h6 class="fw-bold fs-lg-1">Nick Agrawal,<span class="ms-2 fw-normal text-400 fs--1">Data
                          Scientist</span></h6>
                    </div>
                  </div>
                </div>
                <div class="carousel-item">
                  <div class="row h-100 align-items-center">
                    ...
                    <div class="col-md-5 col-lg-6 col-xl-7 mb-4 ms-xxl-auto"><img class="img-fluid"
                        src="assets/img/gallery/quotation.png" alt="testimonials-bg" />
                      <h5 class="fw-bold text-gradient fs-4 mt-4">Exceptionally !!</h5>
                      <p class="mt-4 pe-xxl-8">I'm a senoir developer and trust me it is one of the best websites to
                        shape your carrier.</p>
                      <div class="my-4">
                        <svg class="bi bi-star-fill me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                          fill="#EFAB18" viewBox="0 0 16 16">
                          <path
                      ...
                      <h6 class="fw-bold fs-lg-1">Divyesh Mehta,<span class="ms-2 fw-normal text-400 fs--1">Senior
                          Developer</span></h6>
                    </div>
                  </div>
                </div>
            ...
            <div class="row align-items-center circle-blend circle-blend-right circle-warning">
              <div class="col-md-6 col-lg-4 mb-4 undefined">
                <div class="card card-bg p-3 h-100">
                  <div class="card-body">
                    <h6 class="text-gradient fs--1 fw-bold">Data Science</h6>
                    <hr class="text-100" />
                    <h5 class="fw-bold lh-base fs-1 text-700">Leverage the power of data to drive insights, innovation,
                    ...
                    <div class="d-flex align-items-center"><img class="me-3 me-md-3"
                      ...
                      <div class="my-3 fs--1">
                        ...
                        <p class="fw-normal mb-0">May, 2023 .</p>
                      </div>
                    </div>
              ...
              <div class="col-md-6 col-lg-4 mb-4 circle-blend circle-blend-left circle-pink">
                <div class="card card-bg p-3 h-100">
                  <div class="card-body">
                    <h6 class="text-gradient fs--1 fw-bold">Big Data</h6>
                    <hr class="text-100" />
                    <h5 class="fw-bold lh-base fs-1 text-700">Azure Synapse: Unlocking the Power of Your Data</h5>
                    <div class="d-flex align-items-center"><img class="me-3 me-md-3"
    ...
    <section>
      <div class="bg-holder"
        style="background-image:url(assets/img/illustrations/cta-bg.png);background-position:center;background-size:cover;">
      </div>
      <!--/.bg-holder-->

      <div class="bg-holder"
        style="background-image:url(assets/img/illustrations/cta-bg-1.png);background-position:right top;background-size:auto;margin-top:-38px;margin-left:-200px;">
      </div>
      <!--/.bg-holder-->
      ...
      <div class="container">
        <div class="row flex-center circle-blend circle-blend-right circle-pink">
          <div class="col-xxl-9 py-5 text-center">
            ...
            <p class="mb-6 mx-xxl-11">We hope that this website finds you informative. If you like this share this with
              the one who really needs it and if you are intrested for getting a sutaible job, please Log In to<span
                class="fw-bold">XYZ</span></p><a class="btn hover-top btn-glow btn-klean rounded-pill" href="#">Log
              in</a>
          </div>
        </div>
      </div>
